...
LDFLAGS := -s -w -X github.com/majimenez-stratio/openldap_exporter.commit=${GITCOMMIT}
...
ifeq (, $(shell which goimports))
	...
	@goimports -w -local github.com/majimenez-stratio/openldap_exporter $(shell find . -type f -name '*.go' | grep -v '/vendor/')
